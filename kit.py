...
class IntentKit:
    ...
    def reuse(self, lang="en"):
        if self.lang != lang and os.path.exists(
            f"./features/intent_recognition/snips/engine/{lang}"
        ):
            self.lang = lang
            ...
            self.loaded = True
        elif os.path.exists(f"./features/intent_recognition/snips/engine/{lang}"):
            self.train(lang)
    ...
    def train(self, lang="en"):
        ...
        os.system(
            f"snips-nlu generate-dataset {test} ./features/intent_recognition/snips/data/{lang}.yaml > ./features/intent_recognition/snips/dataset/dataset_{lang}.json"
        )
        dataset_path = (
            f"./features/intent_recognition/snips/dataset/dataset_{lang}.json"
        )
